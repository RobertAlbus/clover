...
SecondOrderResonantButterworthLowPass(T cutoff_freq, T Q, T samplerate) {
...
template <typename T>
IIRFilterCoefficients<T>
SecondOrderResonantButterworthHighPass(T cutoff_freq, T Q, T samplerate) {
  T w0 = 2.0 * M_PI * cutoff_freq / samplerate;
  T alpha = sin(w0) / (2.0 * Q);
...
IIRFilterCoefficients<T>
SecondOrderButterworthResonantBandPass(T center_freq, T Q, T samplerate_hz) {
...
template <FloatingPoint T>
IIRFilterCoefficients<T> SecondOrderButterworthResonantNotch(T center_freq, T Q,
                                                             T samplerate_hz) {
  T w0 = 2.0 * M_PI * center_freq / samplerate_hz;
  T alpha = sin(w0) / (2.0 * Q);
  T cos_w0 = cos(w0);
...
template <FloatingPoint T>
IIRFilterCoefficients<T>
SecondOrderButterworthResonantHighShelf(T center_freq, T Q, T gain_db,
                                        T samplerate_hz) {
  T w0 = 2.0 * M_PI * center_freq / samplerate_hz;
  T alpha = sin(w0) / (2.0 * Q);
...
template <FloatingPoint T>
IIRFilterCoefficients<T>
SecondOrderButterworthResonantPeakingEQ(T center_freq, T Q, T gain_db,
                                        T samplerate_hz) {
  T w0 = 2.0 * M_PI * center_freq / samplerate_hz;
  T alpha = sin(w0) / (2.0 * Q);
  T A = pow(10.0, gain_db / 40.0);
...
template <FloatingPoint T>
IIRFilterCoefficients<T>
SecondOrderButterworthResonantLowShelf(T center_freq, T Q, T gain_db,
                                       T samplerate_hz) {
  T w0 = 2.0 * M_PI * center_freq / samplerate_hz;
  T alpha = sin(w0) / (2.0 * Q);
  T A = pow(10.0, gain_db / 40.0);
