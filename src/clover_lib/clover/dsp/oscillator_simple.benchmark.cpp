...
static void BM_oscillator_simple(benchmark::State& state) {
    auto range = std::views::iota(0, static_cast<int>(clover_bm::samples_10s_48k));
    auto osc   = clover::dsp::oscillator_simple(clover_bm::fs_48k);
    osc.freq(20.965f);
...
static void BM_oscillator_simple_steady(benchmark::State& state) {
    auto range = std::views::iota(0, static_cast<int>(clover_bm::samples_10s_48k));
    auto osc   = clover::dsp::oscillator_simple(clover_bm::fs_48k);
    osc.freq(546.965f);
...
static void BM_oscillator_simple_x8(benchmark::State& state) {
    using namespace clover::dsp;
    auto range = std::views::iota(0, static_cast<int>(clover_bm::samples_10s_48k));

    oscillator_simple oscs[] = {
            oscillator_simple(clover_bm::fs_48k),
            oscillator_simple(clover_bm::fs_48k),
            oscillator_simple(clover_bm::fs_48k),
            oscillator_simple(clover_bm::fs_48k),
            oscillator_simple(clover_bm::fs_48k),
...
static void BM_oscillator_simple_x8_steady(benchmark::State& state) {
    using namespace clover::dsp;
    auto range = std::views::iota(0, static_cast<int>(clover_bm::samples_10s_48k));
